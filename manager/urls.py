...
router.register('expense-category', views.ExpenseCategoryViewSet, basename='expense-category')
router.register('expense-type', views.ExpenseTypeViewSet, basename='expense-type')
...
#    path('', HomePageView.as_view(), name='home'),
    ...
    path('investments/', InvestmentsDashboard.as_view(), name='investments'),
